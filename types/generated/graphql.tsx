...
export type GetUsersQuery = { __typename?: 'query_root' } & {
  users: Array<
    { __typename?: 'users' } & Pick<Users, 'name' | 'id' | 'created_at'>
  >;
};

export type GetUsersLocalQueryVariables = Exact<{ [key: string]: never }>;

export type GetUsersLocalQuery = { __typename?: 'query_root' } & {
  users: Array<
    { __typename?: 'users' } & Pick<Users, 'name' | 'id' | 'created_at'>
  >;
};
...
export type DeleteUserMutation = { __typename?: 'mutation_root' } & {
  delete_users_by_pk?: Maybe<
    { __typename?: 'users' } & Pick<Users, 'created_at' | 'id' | 'name'>
  >;
};
 ...
 * });
 */
export function useGetUsersLocalQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetUsersLocalQuery,
    GetUsersLocalQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetUsersLocalQuery, GetUsersLocalQueryVariables>(
    GetUsersLocalDocument,
    options
  );
}
export function useGetUsersLocalLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetUsersLocalQuery,
    GetUsersLocalQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetUsersLocalQuery, GetUsersLocalQueryVariables>(
    GetUsersLocalDocument,
    options
  );
}
export type GetUsersLocalQueryHookResult = ReturnType<
  typeof useGetUsersLocalQuery
>;
export type GetUsersLocalLazyQueryHookResult = ReturnType<
  typeof useGetUsersLocalLazyQuery
>;
export type GetUsersLocalQueryResult = Apollo.QueryResult<
  GetUsersLocalQuery,
  GetUsersLocalQueryVariables
>;
